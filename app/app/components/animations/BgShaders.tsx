/*
 * @nebulaz · OpenShaders
 * https://openshaders.com/@nebulaz
 * WebGL2 · React component (TypeScript) · dither
 *
 * import { NebulazShader } from "./NebulazShader.webgl.tsx";
 *
 * <NebulazShader theme="dark" style={{ width: 480, height: 300 }} />
 *
...
const float HUE = 0.876458764;
const float HUE_SPREAD = -0.450818777;
const float HUE_TRAVEL = 1.72460341;
const float CHROMA = 0.102718487;
const float LIGHTNESS = 0.639839947;
const float COLOUR_CYCLE = 0.0808053985;
const float THETA = 2.12163067;
const float SHEAR = 0.971300542;
const float SHRINK = 0.952849925;
const float LAYERS = 87.0;
const float WARP_FREQ_X = 0.537114322;
const float WARP_FREQ_Y = 2.25716925;
const float WARP_AMP_X = 0.105262034;
const float WARP_AMP_Y = 0.033696793;
const float ASPECT_X = 2.29213023;
const float ASPECT_Y = 0.186531648;
const float OFFSET_X = 0.417042315;
const float OFFSET_Y = 0.0143946745;
const float TILT = -0.73205477;
const float ZOOM = 1.13415122;
const float CENTRE_X = 0.614987135;
const float CENTRE_Y = 0.0133460518;
const float GLOW_SIZE = 0.00176598586;
const float FALLOFF = 0.468098909;
const float VIGNETTE = 0.0245735627;
const float FLOW_SPEED = 0.601874411;
const float FLOW_DIRECTION = 1.0;
const float BREATH_RATE = 0.522301197;
const float BREATH_AMOUNT = 0.107153952;
const float PHASE = 8.32399845;
const float ECHO = 0.0;
const float ECHO_SHIFT = 0.216949672;
const float SOFTNESS = 0.00160509371;
const float LIGHT_SWING = 0.2198264;
...
const float uStrength = 1.01859927;
const float uScale = 0.957967877;
const float uSeed = 0.951765656;
...
export type NebulazShaderProps = {
  theme?: ShaderTheme;
  background?: { dark?: string; light?: string };
  time?: number;
  onError?: (error: Error) => void;
